...
class CentralCorridor(Scene):
  ...
  def enter(self):
    ...
    if action == "shoot!":
      ...
      print "you are dead.  Then he eats your."
      return 'death'
...
class LaserWeaponArmory(Scene):
  ...
  def enter(self):
    ...
    # LIST COMPARISON TO RETURN LIST INDEX OF SIMILAR VALUE
    # [x for x, ltr in enumerate(list) if ltr == ch]
    ...
    while guess != code and guesses > 1:
      ...
      if guesses < 5:
        hint = list(code)
        print "BZZZZEDD!"
        print "NEW CODE HINT (%d guesses left) = %d%dx" % (guesses, int(hint[0]), int(hint[1]))
        print
      elif guesses < 8:
        hint = list(code)
        print "BZZZZEDD!"
        print "CODE HINT (%d guesses left) = %dxx" % (guesses, int(hint[0]))
        print
      else:
        print "BZZZZEDD!"
